Gem::Specification.new do |spec|
  ...
  spec.files		= %w[ .envrc.example .gitignore Gemfile Gemfile.lock LICENSE.txt README.md Rakefile bin/tp_cli lib/tp_cli/version.rb lib/tp_cli.rb spec/spec_helper.rb spec/tp_cli_spec.rb tp-cli.gemspec]
